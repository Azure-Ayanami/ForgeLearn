...
public class ModFoods {
    ...
    public static final FoodProperties ARACEAE = new FoodProperties.Builder().nutrition(2)
            .saturationMod(1.0f).effect(() -> new MobEffectInstance(ModEffects.PLANT_ALLERGIES.get(), 30), 1.0f).build();

    public static final FoodProperties AMORPHOPHALLUS_TITANUM = new FoodProperties.Builder().nutrition(5)
            .saturationMod(1.0f).effect(() -> new MobEffectInstance(ModEffects.PLANT_ALLERGIES.get(), 60), 1.0f).build();
